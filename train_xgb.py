...
def main():
    ...
    plt.scatter(all_true, all_pred, alpha=0.6, color='#2ca02c', edgecolors='k')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "xgb_parity.png"), dpi=300)
    plt.close()
    
    # Save metrics txt
    with open(os.path.join(out_dir, "xgb_metrics.txt"), 'w', encoding='utf-8') as f:
